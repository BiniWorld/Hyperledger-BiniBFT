...
type BiniBFTSynchronizer struct {
...
func (s *BiniBFTSynchronizer) Sync() BiniBFTSyncResponse {
	s.Logger.Debug("BiniBFT Sync initiated")
	...
	defer func() {
		s.lastReconfig = BiniBFTReconfig{}
	}()
...
func (s *BiniBFTSynchronizer) Buffer() *SyncBuffer {
	s.mutex.Lock()
...
func (s *BiniBFTSynchronizer) synchronize() (*BiniBFTDecision, error) {
...
func (s *BiniBFTSynchronizer) detectTargetHeight() (uint64, string, error) {
...
func (s *BiniBFTSynchronizer) computeTargetHeight(heights []uint64) uint64 {
...
func (s *BiniBFTSynchronizer) createBFTDeliverer(startHeight uint64, myEndpoint string) (BFTBlockDeliverer, error) {
...
func (s *BiniBFTSynchronizer) getBlocksFromSyncBuffer(startHeight, targetHeight uint64) (*common.Block, error) {
